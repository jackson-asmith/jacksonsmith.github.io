...
- Collaborated with senior developers to prune hundreds of terabytes of legacy data, developing a parallelized PowerShell solution using `ForEach-Object -Parallel` that reduced deletion time from days to hours, significantly improving operational efficiency and resource utilization
